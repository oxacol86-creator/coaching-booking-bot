...
def screen2_keyboard():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("📖 More about me", callback_data="bio_s2")],
        [InlineKeyboardButton("I feel this", callback_data="screen3")],
    ])
...
async def on_callback(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if data == "bio_s2":
        await message.reply_text(BIO_TEXT, parse_mode="HTML",
                                  reply_markup=single_button("I feel this", "screen3"))
        return
    if data == "step_proof":
